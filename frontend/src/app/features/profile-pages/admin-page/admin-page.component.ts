import { AfterViewInit, Component, effect, inject, OnInit, Type, WritableSignal } from '@angular/core';
...
import { DashboardModel, LastTimeKeys, TimeSelectedDashboardModel } from 'src/app/shared/models';
